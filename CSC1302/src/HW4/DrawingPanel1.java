...
public class DrawingPanel1 implements ActionListener{
    ...
    public DrawingPanel1(int width, int height) {
        this.width = width;
        this.height = height;
        ...
        MouseInputAdapter listener = new MouseInputAdapter() {
            public void mouseMoved(MouseEvent e) {
                DrawingPanel1.this.statusBar.setText("(" + e.getX() + ", " + e.getY() + ")");
            }

            public void mouseExited(MouseEvent e) {
                DrawingPanel1.this.statusBar.setText(" ");
            }
        };
        ...
        this.frame.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                if (DUMP_IMAGE) {
                    DrawingPanel1.this.save(TARGET_IMAGE_FILE_NAME);
                }
                System.exit(0);
            }
        });
